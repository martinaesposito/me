...
function chooseDirection(){
    ...
    // if (probability <=1/7){n=6}
    // else if (probability <= 1/7*2){n=1}
    // else if (probability <= 1/7*3){n=2}
    // else if (probability <= 1/7*4){n=3}
    // else if (probability <= 1/7*5){n=4}
    // else if (probability <= 1/7*6){n=0}
    // else {n=7}
...
// var btns=document.getElementById('fixed').children;
